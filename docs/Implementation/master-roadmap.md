...
| :--- | :--- | :--- | :--- |
| **Sprint 1 (Week 1–2)** | **Phase 01: Foundation** & **Phase 02: Platform** | Turborepo monorepo, `@repo/database` (Prisma/PostgreSQL), `@repo/logger`, `@repo/ui`, Backlog CLI v1.0.0, Core GitHub Actions CI Pipeline (`.github/workflows/ci.yml`) | Docker, pnpm workspace |
...
| **Sprint 6 (Week 8)** | **Phase 07: Analytics**, **Phase 08: Polish**, & **Phase 09: Production** | Analytics & search endpoints, Accessibility, Monorepo Confidence Gate (`pnpm gate`), Production CD Deployment Pipeline (Coolify VPS automation) | All prior phases |
